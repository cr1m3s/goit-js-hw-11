...
},{"./lib/axios":"../node_modules/axios/lib/axios.js"}],"PixabayAPI.js":[function(require,module,exports) {
"use strict";
...
var API_KEY = '25175816-a3b0e6224fe7d6836881efcec';
var API_URL = 'https://pixabay.com/api/';

var PixabayAPI = /*#__PURE__*/function () {
  function PixabayAPI() {
    _classCallCheck(this, PixabayAPI);

    this.page = 1;
    this.searchQuery = '';
  }

  _createClass(PixabayAPI, [{
    key: "search",
    value: function () {
      var _search = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee() {
        var SEARCH_URL, request;
        return regeneratorRuntime.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                SEARCH_URL = "".concat(API_URL, "?key=").concat(API_KEY, "&q=").concat(this.searchQuery, "&image_type=photo&orientation=horizontal&safesearch=true&page=").concat(this.page, "&per_page=40");
                _context.prev = 1;
                _context.next = 4;
...
},{"regenerator-runtime/runtime":"../node_modules/regenerator-runtime/runtime.js","axios":"../node_modules/axios/index.js"}],"../node_modules/notiflix/build/notiflix-notify-aio.js":[function(require,module,exports) {
var define;
...
var _PixabayAPI = _interopRequireDefault(require("./PixabayAPI"));
...
var service = new _PixabayAPI.default();
...
function startSearch(event) {
  ...
  service.search().then(function (_ref) {
    var hits = _ref.hits,
    ...
    _notiflixNotifyAio.Notify.info("Hooray! We found ".concat(totalHits, " images."));
...
function galleryConstructor(cards) {
  var result = cards.map(function (_ref2) {
    var webformatURL = _ref2.webformatURL,
        tags = _ref2.tags,
        likes = _ref2.likes,
        views = _ref2.views,
        comments = _ref2.comments,
        downloads = _ref2.downloads;
    return "<a href=\"".concat(webformatURL, "\">\n                <img src=\"").concat(webformatURL, "\" alt=\"").concat(tags, "\" loading=\"lazy\" />\n                <div class=\"info\">\n                    <p class=\"info-item\">\n                        Likes: <b>").concat(likes, "</b>\n                    </p>\n                    <p class=\"info-item\">\n                        Views: <b>").concat(views, "</b>\n                    </p>\n                    <p class=\"info-item\">\n                        Comments: <b>").concat(comments, "</b>\n                    </p>\n                    <p class=\"info-item\">\n                        Downloads: <b>").concat(downloads, "</b>\n                    </p>\n                </div>\n            </a>");
  }).join('');
  gallery.insertAdjacentHTML('beforeend', result);
}

function endOfSearch() {
  service.search().then(function (_ref3) {
    var hits = _ref3.hits,
        totalHits = _ref3.totalHits;
...
function loadMore() {
  service.search().then(function (_ref4) {
    var hits = _ref4.hits,
        totalHits = _ref4.totalHits;

    if (totalHits < 12) {
      _notiflixNotifyAio.Notify.failure("\"We're sorry, \n        but you've reached the end of search results.\"");
